...
st.sidebar.write("")
st.sidebar.write("")
data1 = st.sidebar.file_uploader("Upload File 1 Here",
                                 type={"csv"})
data2 = st.sidebar.file_uploader("Upload File 2 Here",
                                 type={"csv"})
...
try:
    ...
    data_df1_missing = data_df1['median_price_12'].isnull().sum()
    data_df2_missing = data_df2['median_price_12'].isnull().sum()
    ...
    with plot_tab:
        ...
        with c1:
            ...
            fig1.add_trace(go.Line(name=data1.name,
                                   ...
                                   y=data_df1_series['median_price_12']))
        ...
        with c2:
            ...
            fig3.add_trace(go.Line(name=data2.name,
                                   ...
                                   y=data_df2_series['median_price_12']))
        ...
        corr = round(data_df1.corrwith(data_df2)['median_price_12'], 2)
